...
import com.szk.auth.common.enums.AuthUserStatusEnum;
import com.szk.auth.domain.constants.AuthConstant;
import com.szk.auth.domain.convert.AuthUserBOConverter;
import com.szk.auth.domain.entity.AuthUserBO;
import com.szk.auth.domain.redis.RedisUtil;
import com.szk.auth.domain.service.AuthUserDomainService;
import com.szk.auth.infra.basic.entity.*;
import com.szk.auth.infra.basic.service.AuthPermissionService;
import com.szk.auth.infra.basic.service.AuthRoleService;
import com.szk.auth.infra.basic.service.AuthUserRoleService;
...
public class AuthUserDomainServiceImpl implements AuthUserDomainService {
    ...
    public Boolean register(AuthUserBO authUserBO) {
        ...
        if (StringUtils.isBlank(authUser.getAvatar())) {
            authUser.setAvatar("http://124.70.93.22:9000/user/icon/微信图片_20231203153718(1).png");
        }
